				...
				<div>
					<div id = "menubuttons" >
						...
						<div class = "col-md-3" id = "cuatro" >
                            ...
                            href = "mostrar_cursos.php?opc=modificar" target = "_self" title = "Modificar noticia" >
						...
						<div class = "col-md-3" id = "cinco" >
							<a class = "btn btn-block btn-lg btn-danger" href = "mostrar_cursos.php?opc=eliminar" target ="_self" title = "Eliminar noticia" >
