(function(){
    ...
    function init(){
        var inputtag = document.getElementById("mood");
    ...
    function filter(event) {
        ...
        var allowed = "01";     // Caracteres válidos
        var messageElement = document.getElementById("checkmood");  // Mensaje a ocultar/mostrar
