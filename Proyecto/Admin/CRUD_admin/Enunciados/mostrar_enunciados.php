		...
		<body class="container">
			<?php
				...
				if (isset($_POST[ 'guardar' ])) {
						...
						$idenun = isset($_POST[ 'idenun' ]) ? trim($_POST[ 'idenun' ]) : 0;
						...
						$consulta = "update enunciados set Id_Enun = " . $idenun . ",  Titulo = '" . $titulo . "',  Descripcion = '" . $descripcion . "', Fecha = '" . $fecha . "' WHERE Id_Enun = '" . $id . "'";
				...
				if (isset($_GET[ 'del' ]) && $_GET[ 'del' ] == "s" ) {
					...
					$resultc = $db->query($consulta);
					$num_results = $db->affected_rows;
					echo "se ha eliminado" . $num_results . " enunciado de id = " . $_GET[ 'id' ] . "<br>" ;
				}
